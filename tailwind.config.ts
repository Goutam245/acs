  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        cyan: {
          start: "hsl(var(--cyan-start))",
          end: "hsl(var(--cyan-end))",
        },
        gold: "hsl(var(--gold-premium))",
      ...
      backgroundImage: {
        ...
        "hero-gradient": "radial-gradient(ellipse at top, rgba(10,22,40,0.3) 0%, rgba(10,22,40,0.9) 100%)",
      },
      boxShadow: {
        "glow": "0 0 40px rgba(0, 212, 255, 0.3)",
        "glow-lg": "0 0 60px rgba(0, 212, 255, 0.4)",
        "card": "0 20px 50px -20px rgba(0, 0, 0, 0.5)",
        "elevated": "0 25px 60px -15px rgba(0, 0, 0, 0.6)",
      },
    },
  },
